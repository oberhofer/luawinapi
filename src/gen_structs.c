...
{
  { "lpData", offsetof(MIDIHDR, lpData), "$ptr"},
...
{
  { "lpData", offsetof(WAVEHDR, lpData), "$ptr"},
...
int winapi_CloseHandle( lua_State *L )
{
  ...
  hObject = (HANDLE)winapi_tohandle(L, 1);
...
int winapi_GetModuleHandleExW( lua_State *L )
{
  ...
  p1 = (DWORD)lua_tonumber(L, 1);
  p2 = winapi_towidestring_Z(L, 2);
  p3 = (HMODULE)winapi_tohandle(L, 3);
...
int winapi_CreateProcessW( lua_State *L )
{
  ...
  {
    size_t sourcelen;
    LPCWSTR source = winapi_widestringfromutf8_Z(L, 2, &sourcelen);
    
    size_t buflen = sizeof(WCHAR) * sourcelen;
    p2 = (LPWSTR)malloc(buflen);
    if (NULL == p2)
    {
...
int winapi_LoadResource( lua_State *L )
{
  ...
  p1 = (HMODULE)winapi_tohandle(L, 1);
  p2 = (HRSRC)winapi_tohandle(L, 2);
...
int winapi_UnregisterClassW( lua_State *L )
{
  ...
  p1 = winapi_towidestring_Z(L, 1);
  p2 = (HINSTANCE)winapi_tohandle(L, 2);
...
int winapi_GetClassInfoW( lua_State *L )
{
  ...
  p1 = (HINSTANCE)winapi_tohandle(L, 1);
  p2 = winapi_towidestring_Z(L, 2);
...
int winapi_CreateWindowExW( lua_State *L )
{
  ...
  p1 = (DWORD)lua_tonumber(L, 1);
  p2 = winapi_towidestring_or_atom_Z(L, 2);
  p3 = winapi_towidestring_Z(L, 3);
  ...
  p9 = lua_toWindow(L, 9);
  p10 = (HMENU)winapi_tohandle(L, 10);
  p11 = (HINSTANCE)winapi_tohandle(L, 11);
...
int winapi_FindWindowW( lua_State *L )
{
  ...
  p1 = winapi_towidestring_or_atom_Z(L, 1);
  if (!lua_isnil(L, 2))
  {
    p2 = winapi_towidestring_Z(L, 2);
  }
...
int winapi_GetKeyNameTextW( lua_State *L )
{
  ...
  p1 = lua_tointeger(L, 1);
  cchSize = lua_tointeger(L, 3);

  {
    size_t buflen = sizeof(WCHAR) * cchSize;
    p2 = (LPWSTR)malloc(buflen);
    if (NULL == p2)
    {
      luaL_error(L, "internal malloc error");
  ...
  winapi_pushlwidestring_Z(L, p2, cchSize); ++numret;
  free(p2);
...
int winapi_InsertMenuW( lua_State *L )
{
  ...
  p2 = (UINT)lua_tonumber(L, 2);
  p3 = (UINT)lua_tonumber(L, 3);
  p4 = (UINT_PTR)winapi_tohandle(L, 4);
  p5 = winapi_towidestring_Z(L, 5);
...
int winapi_AppendMenuW( lua_State *L )
{
  ...
  p1 = (HMENU)winapi_tohandle(L, 1);
  p2 = (UINT)lua_tonumber(L, 2);
  p3 = (UINT_PTR)winapi_tohandle(L, 3);
  p4 = winapi_towidestring_Z(L, 4);
...
int winapi_SetMenuItemBitmaps( lua_State *L )
{
  ...
  p2 = (UINT)lua_tonumber(L, 2);
  p3 = (UINT)lua_tonumber(L, 3);
  p4 = (HBITMAP)winapi_tohandle(L, 4);
  p5 = (HBITMAP)winapi_tohandle(L, 5);
...
int winapi_SetMessageExtraInfo( lua_State *L )
{
  ...
  p1 = (LPARAM)winapi_tolwparam(L, 1);
...
int winapi_PostMessageW( lua_State *L )
{
  ...
  p1 = lua_toWindow(L, 1);
  p2 = (UINT)lua_tonumber(L, 2);
  p3 = (WPARAM)winapi_tolwparam(L, 3);
  p4 = (LPARAM)winapi_tolwparam(L, 4);
...
int winapi_CallWindowProcW( lua_State *L )
{
  ...
  p1 = (WNDPROC)winapi_tohandle(L, 1);
  p2 = lua_toWindow(L, 2);
  p3 = (UINT)lua_tonumber(L, 3);
  p4 = (WPARAM)winapi_tolwparam(L, 4);
  p5 = (LPARAM)winapi_tolwparam(L, 5);
...
int winapi_CreateCaret( lua_State *L )
{
  ...
  p1 = lua_toWindow(L, 1);
  p2 = (HBITMAP)winapi_tohandle(L, 2);
  p3 = lua_tointeger(L, 3);
  p4 = lua_tointeger(L, 4);
...
int winapi_LoadIconW( lua_State *L )
{
  ...
  p1 = (HINSTANCE)winapi_tohandle(L, 1);
  p2 = (LPCWSTR)winapi_toresourceref(L, 2);
...
int winapi_SetCursor( lua_State *L )
{
  ...
  p1 = (HCURSOR)winapi_tohandle(L, 1);
...
int winapi_CreateDialogParamW( lua_State *L )
{
  ...
  p2 = winapi_towidestring_Z(L, 2);
  p3 = lua_toWindow(L, 3);
  p4 = (DLGPROC)winapi_tohandle(L, 4);
  p5 = (LPARAM)winapi_tolwparam(L, 5);
...
int winapi_GetDlgItemTextW( lua_State *L )
{
  ...
  p1 = lua_toWindow(L, 1);
  p2 = lua_tointeger(L, 2);
  cchMax = lua_tointeger(L, 4);

  {
    size_t buflen = sizeof(WCHAR) * cchMax;
    p3 = (LPWSTR)malloc(buflen);
    if (NULL == p3)
    {
      luaL_error(L, "internal malloc error");
    }
  ...
  winapi_pushlwidestring_Z(L, p3, cchMax); ++numret;
  free(p3);
...
int winapi_GetClipboardFormatNameW( lua_State *L )
{
  ...
  p1 = (UINT)lua_tonumber(L, 1);
  cchMaxCount = lua_tointeger(L, 3);

  {
    size_t buflen = sizeof(WCHAR) * cchMaxCount;
    p2 = (LPWSTR)malloc(buflen);
    if (NULL == p2)
    {
      luaL_error(L, "internal malloc error");
  ...
  winapi_pushlwidestring_Z(L, p2, cchMaxCount); ++numret;
  free(p2);
...
int winapi_DeleteObject( lua_State *L )
{
  ...
  p1 = (HGDIOBJ)winapi_tohandle(L, 1);
...
int winapi_SelectObject( lua_State *L )
{
  ...
  p1 = lua_toDC(L, 1);
  p2 = (HGDIOBJ)winapi_tohandle(L, 2);
...
int winapi_CreatePatternBrush( lua_State *L )
{
  ...
  p1 = (HBITMAP)winapi_tohandle(L, 1);
...
int winapi_CreateFontW( lua_State *L )
{
  ...
  p14 = winapi_towidestring_Z(L, 14);
...
int winapi_wglCopyContext( lua_State *L )
{
  ...
  p1 = (HGLRC)winapi_tohandle(L, 1);
  p2 = (HGLRC)winapi_tohandle(L, 2);
  p3 = (UINT)lua_tonumber(L, 3);
...
int winapi_ImageList_AddMasked( lua_State *L )
{
  ...
  p1 = (HIMAGELIST)winapi_tohandle(L, 1);
  p2 = (HBITMAP)winapi_tohandle(L, 2);
  p3 = (COLORREF)lua_tonumber(L, 3);
...
int winapi_SHHandleWMActivate( lua_State *L )
{
  ...
  p1 = lua_toWindow(L, 1);
  p2 = (WPARAM)winapi_tolwparam(L, 2);
  p3 = (LPARAM)winapi_tolwparam(L, 3);
...
int winapi_CommandBar_InsertMenubar( lua_State *L )
{
  ...
  p1 = lua_toWindow(L, 1);
  p2 = (HINSTANCE)winapi_tohandle(L, 2);
  p3 = (WORD)lua_tointeger(L, 3);
  p4 = (WORD)lua_tointeger(L, 4);
...
int winapi_MultiByteToWideChar( lua_State *L )
{
  ...
  p1 = (UINT)lua_tonumber(L, 1);
  p2 = (DWORD)lua_tonumber(L, 2);
  p3 = (LPCSTR)lua_tostring(L, 3);
  p4 = lua_tointeger(L, 4);
  cchWideChar = lua_tointeger(L, 6);

  {
    size_t buflen = sizeof(WCHAR) * cchWideChar;
    p5 = (LPWSTR)malloc(buflen);
    if (NULL == p5)
    {
      luaL_error(L, "internal malloc error");
    }
  ...
  winapi_pushlwidestring_Z(L, p5, cchWideChar); ++numret;
  free(p5);
...
int winapi_WideCharToMultiByte( lua_State *L )
{
  ...
  p3 = winapi_towidestring_Z(L, 3);
  p4 = lua_tointeger(L, 4);
  p5 = (LPSTR)lua_tostring(L, 5);
  p6 = lua_tointeger(L, 6);
  p7 = (LPCSTR)lua_tostring(L, 7);
  p8 = lua_tointeger(L, 8);
...
int winapi_PlaySoundW( lua_State *L )
{
  ...
  p1 = winapi_towidestring_Z(L, 1);
  p2 = (HMODULE)winapi_tohandle(L, 2);
  p3 = (DWORD)lua_tonumber(L, 3);
...
int winapi_waveOutGetErrorTextW( lua_State *L )
{
  ...
  cchText = (UINT)lua_tonumber(L, 3);

  {
    size_t buflen = sizeof(WCHAR) * cchText;
    p2 = (LPWSTR)malloc(buflen);
    if (NULL == p2)
    {
      luaL_error(L, "internal malloc error");
  ...
  winapi_pushlwidestring_Z(L, p2, cchText); ++numret;
  free(p2);
...
static const luaL_Reg module_lib[ ] = {
  ...
  { "CloseHandle",  winapi_CloseHandle },
  { "GetHandleInformation",  winapi_GetHandleInformation },
  { "SetHandleInformation",  winapi_SetHandleInformation },
  ...
  { "IsValidCodePage",  winapi_IsValidCodePage },
  { "GetACP",  winapi_GetACP },
  { "GetOEMCP",  winapi_GetOEMCP },
  { "IsDBCSLeadByte",  winapi_IsDBCSLeadByte },
  { "IsDBCSLeadByteEx",  winapi_IsDBCSLeadByteEx },
  { "MultiByteToWideChar",  winapi_MultiByteToWideChar },
  { "WideCharToMultiByte",  winapi_WideCharToMultiByte },
